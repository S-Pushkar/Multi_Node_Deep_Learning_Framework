...
vector<Activation> parse_activations(const vector<string>& activations_str) {
    ...
    for (const auto& act : activations_str) {
        if (act == "sigmoid") activations.push_back(Activation::SIGMOID);
        else if (act == "tanh") activations.push_back(Activation::TANH);
        else if (act == "relu") activations.push_back(Activation::RELU);
        else if (act == "linear") activations.push_back(Activation::LINEAR);
        else {
